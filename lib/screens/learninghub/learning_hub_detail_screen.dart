...
import 'package:onboardx_app/screens/learninghub/document_viewer_screen.dart';
import 'package:onboardx_app/screens/learninghub/video_player_screen.dart';
...
class _LearningHubDetailScreenState extends State<LearningHubDetailScreen> {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => DocumentViewerScreen(
          ...
          documentTitle: (AppLocalizations.of(context)!.lessonDocument),
  ...
  if (user == null) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text((AppLocalizations.of(context)!.pleaseSignToTrackProgress))),
    );
    return;
  }
